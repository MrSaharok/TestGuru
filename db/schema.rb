...
ActiveRecord::Schema.define(version: 2023_07_03_143949) do
  ...
  create_table "test_passings", force: :cascade do |t|
    ...
    t.index ["question_id"], name: "index_test_passings_on_question_id"
  ...
  add_foreign_key "test_passings", "questions"
